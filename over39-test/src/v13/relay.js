...
const forwardingCopy = {
  ko: { title: "이 안부를 읽고 다음 사람에게 한 문장 남기기", help: "남긴 문장은 원문 그대로 보존하며 연락처는 누구에게도 공개하지 않습니다. 이 문장은 다음 사람에게 이어질 새 안부로 기다립니다.", send: "다음 안부 맡기기", sent: "다음 안부를 맡겼습니다.", notificationTitle: "다음 안부가 도착하면 이메일로 알려드릴까요?", notificationHelp: "이메일은 안부함 링크를 보내는 데만 사용하며, 다른 참여자에게 보이지 않습니다.", notificationLabel: "알림을 받을 이메일", notificationConsent: "이 이메일을 다음 안부 도착 알림에만 사용해도 괜찮아요.", notificationSave: "알림 요청 저장", notificationStored: "알림 요청을 저장했습니다. 이메일 발송은 새 안부가 도착했을 때만 진행됩니다." },
  en: { title: "After reading, leave one sentence for the next person", help: "Your original words are preserved and your contact details are never shown. This sentence waits as a new greeting for a later participant.", send: "Entrust the next greeting", sent: "The next greeting has been entrusted.", notificationTitle: "Would you like an email when another greeting arrives?", notificationHelp: "Your email is used only to send a mailbox link and is never shown to another participant.", notificationLabel: "Email for notices", notificationConsent: "This email may be used only for notice of a next greeting.", notificationSave: "Save notification request", notificationStored: "Your notification request is stored. An email is sent only if another greeting arrives." },
  ja: { title: "この便りを読み、次の人へ一文を残す", help: "残した文章の原文は保管され、連絡先は誰にも公開されません。この一文は次の人へ続く新しい便りとして待ちます。", send: "次の便りを託す", sent: "次の便りを託しました。", notificationTitle: "次の便りが届いた時にメールで知らせますか？", notificationHelp: "メールは便り箱へのリンクを送るためだけに使い、他の参加者には見せません。", notificationLabel: "通知を受けるメールアドレス", notificationConsent: "このメールを次の便りの到着通知だけに使ってよいです。", notificationSave: "通知の依頼を保存", notificationStored: "通知の依頼を保存しました。メールは次の便りが届いた時だけ送られます。" },
  "zh-Hans": { title: "读完后，为下一位参与者留下一句话", help: "你留下的原文会被保留，联系方式不会公开给任何人。这句话会作为新的问候等待下一位参与者。", send: "托付下一封问候", sent: "下一封问候已托付。", notificationTitle: "下一封问候到达时，是否通过邮件通知你？", notificationHelp: "邮箱仅用于发送信箱链接，不会向其他参与者公开。", notificationLabel: "接收通知的邮箱", notificationConsent: "此邮箱仅可用于下一封问候的到达通知。", notificationSave: "保存通知请求", notificationStored: "通知请求已保存。只有新的问候到达时才会发送邮件。" },
  "zh-Hant": { title: "讀完後，為下一位參與者留下一句話", help: "你留下的原文會被保留，聯絡方式不會公開給任何人。這句話會作為新的問候等待下一位參與者。", send: "託付下一封問候", sent: "下一封問候已託付。", notificationTitle: "下一封問候到達時，是否透過電子郵件通知你？", notificationHelp: "電子郵件僅用於發送信箱連結，不會向其他參與者公開。", notificationLabel: "接收通知的電子郵件", notificationConsent: "此電子郵件僅可用於下一封問候的到達通知。", notificationSave: "儲存通知請求", notificationStored: "通知請求已儲存。只有新的問候到達時才會發送電子郵件。" },
  fr: { title: "Après cette lecture, laisser une phrase pour la personne suivante", help: "Votre texte original est conservé et vos coordonnées ne sont montrées à personne. Cette phrase attend comme un nouveau message pour une prochaine personne participante.", send: "Confier le prochain message", sent: "Le prochain message a été confié.", notificationTitle: "Souhaitez-vous un e-mail lorsqu’un autre message arrive ?", notificationHelp: "Votre e-mail sert seulement à envoyer un lien vers la boîte et n’est jamais montré à une autre personne participante.", notificationLabel: "E-mail pour les notifications", notificationConsent: "Cet e-mail peut être utilisé seulement pour l’arrivée d’un prochain message.", notificationSave: "Enregistrer la demande", notificationStored: "Votre demande est enregistrée. Un e-mail sera envoyé seulement si un nouveau message arrive." },
  es: { title: "Después de leerlo, deje una frase para la siguiente persona", help: "Su texto original se conserva y sus datos de contacto no se muestran a nadie. Esta frase espera como un nuevo saludo para otra persona participante.", send: "Confiar el siguiente saludo", sent: "El siguiente saludo ha sido confiado.", notificationTitle: "¿Quiere recibir un correo cuando llegue otro saludo?", notificationHelp: "Su correo se usa solo para enviar un enlace al buzón y nunca se muestra a otra persona participante.", notificationLabel: "Correo para avisos", notificationConsent: "Este correo puede usarse solo para avisar de un próximo saludo.", notificationSave: "Guardar solicitud de aviso", notificationStored: "La solicitud de aviso se ha guardado. Solo se enviará un correo si llega otro saludo." },
  nl: { title: "Laat na het lezen één zin achter voor de volgende persoon", help: "Uw oorspronkelijke tekst blijft bewaard en uw contactgegevens worden aan niemand getoond. Deze zin wacht als nieuwe groet voor een volgende deelnemer.", send: "De volgende groet toevertrouwen", sent: "De volgende groet is toevertrouwd.", notificationTitle: "Wilt u een e-mail wanneer een volgende groet aankomt?", notificationHelp: "Uw e-mailadres wordt alleen gebruikt om een mailboxlink te sturen en wordt nooit aan een andere deelnemer getoond.", notificationLabel: "E-mail voor meldingen", notificationConsent: "Dit e-mailadres mag alleen worden gebruikt voor een volgende groetmelding.", notificationSave: "Meldingsverzoek opslaan", notificationStored: "Uw meldingsverzoek is opgeslagen. Alleen bij een nieuwe groet wordt e-mail verstuurd." },
...
function render() {
  ...
  if (state.result) { root.innerHTML = `<main class="relay-layout"><section class="relay-card"><div class="relay-project-mark" aria-hidden="true">39+</div><div class="archive-label">${text(c().label)}</div><h1>${text(state.result)}</h1>${notification}</section></main>`; return; }
