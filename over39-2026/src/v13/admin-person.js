...
import { buildRecord, buildRecordBundle, collectSnapshots, polishChosenText, polishForValue, renderRecordBundleHtml } from "./record-export.js?v=v7-20260924-r81";
import { renderResponseDocument, summaryParagraphsOf } from "./response-document.js?v=v7-20260924-r81";
import { LABELS } from "./research-insights.js?v=v7-20260924-r81";
