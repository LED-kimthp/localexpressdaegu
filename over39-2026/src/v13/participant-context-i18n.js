...
const contextualLanguage = {
  ...
  "zh-Hans": { AUDIENCE: ["让我们看看您最近与文化艺术相遇的方式。","哪种描述最接近您最近接触文化艺术的方式？","哪种描述最接近您实际参观和参与的节奏？","请分享一个让您觉得接触文化艺术的方式发生变化的时刻。","即使没有寻找演出、展览或项目，是否仍有持续的兴趣？","哪些现实条件正在影响您最近接触文化艺术的方式？","什么基础或契机帮助您重新接触并记住文化艺术？"], EVERYDAY: ["让我们看看这项活动如何在日常生活中延续。","哪种描述最接近这项活动最近延续的样子？","哪种描述最接近这项活动通过练习、聚会、演出或分享与他人相遇的方式？","请分享一个场景，说明这种变化如何出现在练习、聚会、演出或生活节奏中。","即使不太显眼，是否仍有练习、聚会、学习或关系在延续？","哪些生活和现实条件正在影响这项活动的节奏？","哪些人、空间、学习或生活基础帮助这项活动延续？"], PROFESSIONAL: ["让我们分别看看目前的活动与它和外界相遇的方式。","哪种描述最接近您目前最重要的文化艺术活动状态？","哪种描述最接近这项活动目前与外界相遇的方式？","请分享一件在那前后发生变化的事。","即使外界不易看见，那段时间是否仍有某些事在延续？","哪些现实正在影响您目前的活动方式？","是什么基础或契机让您至今能够继续这项活动？"] },
  "zh-Hant": { AUDIENCE: ["讓我們看看您最近與文化藝術相遇的方式。","哪種描述最接近您最近接觸文化藝術的方式？","哪種描述最接近您實際參觀和參與的節奏？","請分享一個讓您覺得接觸文化藝術的方式發生變化的時刻。","即使沒有尋找演出、展覽或計畫，是否仍有持續的興趣？","哪些現實條件正在影響您最近接觸文化藝術的方式？","什麼基礎或契機幫助您重新接觸並記住文化藝術？"], EVERYDAY: ["讓我們看看這項活動如何在日常生活中延續。","哪種描述最接近這項活動最近延續的樣子？","哪種描述最接近這項活動透過練習、聚會、演出或分享與他人相遇的方式？","請分享一個場景，說明這種變化如何出現在練習、聚會、演出或生活節奏中。","即使不太顯眼，是否仍有練習、聚會、學習或關係在延續？","哪些生活和現實條件正在影響這項活動的節奏？","哪些人、空間、學習或生活基礎幫助這項活動延續？"], PROFESSIONAL: ["讓我們分別看看目前的活動與它和外界相遇的方式。","哪種描述最接近您目前最重要的文化藝術活動狀態？","哪種描述最接近這項活動目前與外界相遇的方式？","請分享一件在那前後發生變化的事。","即使外界不易看見，那段時間是否仍有某些事在延續？","哪些現實正在影響您目前的活動方式？","是什麼基礎或契機讓您至今能夠繼續這項活動？"] },
