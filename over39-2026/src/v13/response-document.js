...
import { LABELS as RESEARCH_LABELS } from "./research-insights.js?v=v7-20260913-r30";
import { normalizedDScope } from "./flow.js?v=v7-20260913-r30";
// 설문이 참여자에게 보여준 문구를 부록도 그대로 쓴다. 부록이 자기 사전을 따로 들면
// 같은 값이 두 이름으로 불리고, 사전을 채워도 부록은 비어 있게 된다(2026-09-11).
import { translate } from "./i18n.js?v=v7-20260913-r30";
import { stage1Copy } from "./stage1-i18n.js?v=v7-20260913-r30";
