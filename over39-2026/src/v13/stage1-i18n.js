...
const copy = {
  ...
  en: {
    ...
    introRecord: "Your responses become one participation record at the end. You may then encounter a greeting from someone whose record connects with yours.", introFrame: "Each record is read along three directions — the meaning of the memory, the present flow, and the conditions for continuing. Each direction has four paths, sixty-four positions in all, and records are laid side by side across them.",
    ...
    recordSavedTitle: "Thank you for leaving your responses.", recordSavedLead: "Your answers have been gathered into one participation record.", recordSavedNext: "You can now choose how far this record may be used in research, and see whether a greeting has been connected to you.",
...
const finalGoldCopy = {
  ...
  ja: {
    ...
    introAi: "調査の途中で、必要な場合にAIが二、三度まで質問を加えることがあります。参加記録の下書きはAIが整え、あなた自身が読みながら文章を直せます。",
  ...
  "zh-Hans": {
    ...
    introRecord: "您留下的内容会整理成一份参与记录。亲自阅读并修改后，如您愿意，可以收到一则由先经过这里的人留下的问候。",
    introAi: "问卷进行期间，AI会在需要时最多再提两三次问题。参与记录的草稿由AI整理，您可以亲自阅读并调整句子。",
    introVoluntary: "参与完全自愿。难以回答的问题可以跳过，也可以随时停止。",
    ready: "请在能够暂时专注于自己故事的时候开始。",
    durationPending: "预计用时将在确认实际参与时间后提供。",
    researchCardDescription: "从记忆中的一个场景开始，慢慢听您讲述当下的变化，以及今后继续下去所需的条件。",
  },
  "zh-Hant": {
    ...
    introRecord: "您留下的內容會整理成一份參與記錄。親自閱讀並修改後，如您願意，可以收到一則由先經過這裡的人留下的問候。",
    introAi: "問卷進行期間，AI會在需要時最多再提兩三次問題。參與記錄的草稿由AI整理，您可以親自閱讀並調整句子。",
    introVoluntary: "參與完全自願。難以回答的問題可以跳過，也可以隨時停止。",
    ready: "請在能夠暫時專注於自己故事的時候開始。",
    durationPending: "預計所需時間將在確認實際參與時間後提供。",
    researchCardDescription: "從記憶中的一個場景開始，慢慢聽您說當下的變化，以及今後繼續下去所需的條件。",
  },
  fr: {
    ...
    introAi: "Pendant le questionnaire, l’IA peut poser jusqu’à deux ou trois questions supplémentaires lorsque c’est nécessaire. Elle organise un brouillon du récit de participation, que vous pouvez lire et reformuler vous-même.",
    introVoluntary: "La participation est volontaire. Vous pouvez passer les questions difficiles et arrêter à tout moment.",
  ...
  es: {
    ...
    introAi: "Durante la encuesta, la IA puede hacer hasta dos o tres preguntas más cuando sea necesario. La IA organiza un borrador del registro de participación y usted puede leerlo y ajustar las frases.",
    introVoluntary: "La participación es voluntaria. Puede omitir las preguntas difíciles y detenerse en cualquier momento.",
  ...
  nl: {
    ...
    introAi: "Tijdens de vragenlijst kan AI zo nodig tot twee of drie extra vragen stellen. AI ordent een concept van het participatieverslag, waarna u de zinnen zelf kunt lezen en aanpassen.",
    introVoluntary: "Deelname is vrijwillig. U kunt moeilijke vragen overslaan en op elk moment stoppen.",
  ...
  ms: {
    ...
    introAi: "Semasa soal selidik, AI boleh mengemukakan sehingga dua atau tiga soalan tambahan apabila diperlukan. AI menyusun draf rekod penyertaan, dan anda boleh membacanya serta memperhalus ayat sendiri.",
    introVoluntary: "Penyertaan adalah secara sukarela. Anda boleh melangkau soalan yang sukar dan berhenti pada bila-bila masa.",
