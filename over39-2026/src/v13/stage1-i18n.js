...
const finalGoldCopy = {
  ...
  "zh-Hans": {
    ...
    introAi: "问卷进行期间，AI会在需要时多问一两次。参与记录的草稿由AI整理，您可以亲自阅读并调整句子。",
  ...
  "zh-Hant": {
    ...
    introAi: "問卷進行期間，AI會在需要時多問一兩次。參與記錄的草稿由AI整理，您可以親自閱讀並調整句子。",
