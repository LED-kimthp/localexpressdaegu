import { localizeQuestion, translate } from "./i18n.js?v=v7-20260912-r23";
import { COORDINATE_SCOPE_LABELS, buildCoordinateSnapshots, deriveCoordinateScope, deriveSContextTags } from "./classification.js?v=v7-20260912-r23";
import { buildConnectionProfile, connectionTopics } from "./connection.js?v=v7-20260912-r23";
import { applicableFixedQuestionIds, buildActiveScreens, fixedQuestionIdsForScreen, flowCounts, hasSubstantiveDChange, hasSubstantiveTransition, needsContinuityQuestion, needsPauseContext, normalizedDScope, resetForRouteChange, sanitizeAnswersForRoute, withdrawAnswer } from "./flow.js?v=v7-20260912-r23";
import { ACTIVE_ANCHOR_ORDER, ADAPTIVE_POLICY_VERSION, ALL_ADAPTIVE_SCREEN_MAP, ANCHOR_AXES, ANCHOR_ORDER, aggregateAnchorSource, anchorAnswerFingerprint, anchorContextFingerprint, anchorSourceText, anchorsAffectedByChangedQuestion, assessAnchorNeed, buildAnchorContext, conditionalAnchorsAffectedByChangedQuestion, createAnchorFollowup, isLowInformationText, isStrictRealMotifPass, lowInformationReason, reconcileAnchorTurnsAfterQuestionEdit, upsertAnchorTurn, verifyDomQuestion } from "./anchor-live.js?v=v7-20260912-r23";
import { normalizeIntegratedRoleRecord, shouldShowP13Text, shouldShowP19Text, translationReuseDecision } from "./integration-r2-helpers.js?v=v7-20260912-r23";
import { ADAPTIVE_CHECKPOINTS, DEPTH_AXIS_OPTIONS, buildAdaptiveContext, buildAdaptiveSummaryContext, buildDepthTurnContext, buildMinimalDepthContext, buildMinimalSummaryContext, createAdaptiveSummary, createAdaptiveTurn, createDepthPlan, createDepthQuestion, createDepthSummary, isLiveModelSource, translateResponseSummary } from "./depth.js?v=v7-20260912-r23";
import { QUESTION_METADATA } from "./question-map.js?v=v7-20260912-r23";
import { createEnvelope, readOutbox, retryOutbox, sendEnvelope, splitResearchAndContact } from "./storage.js?v=v7-20260912-r23";
import { RESPONSE_DOCUMENT_VERSION, buildResponseDocument, rawParticipantWords, renderResponseDocument } from "./response-document.js?v=v7-20260912-r23";
import { responseDocumentFrame } from "./response-document-i18n.js?v=v7-20260912-r23";
import { compactParticipantContext, contextAwareCopy, dContextHints, hasParticipantContext, participantContextKind, participantContextOptions } from "./participant-context.js?v=v7-20260912-r23";
import { participantActivityScreenCopy, participantContextCopy } from "./participant-context-i18n.js?v=v7-20260912-r23";
import { greetingUiCopy } from "./greetings-ui-i18n.js?v=v7-20260912-r23";
import { rc2UiCopy, rc2UiPhrase } from "./rc2-ui-i18n.js?v=v7-20260912-r23";
import { completionCopy } from "./completion-i18n.js?v=v7-20260912-r23";
import { greetingVisibilityCopy, stage1ConsentCopy, stage1Copy, stage1UiExtraCopy } from "./stage1-i18n.js?v=v7-20260912-r23";
import { greetingFirstCopy } from "./greeting-first-i18n.js?v=v7-20260912-r23";
import { greetingSimplificationCopy } from "./greeting-simplification-i18n.js?v=v7-20260912-r23";
import { task7Copy } from "./task7-i18n.js?v=v7-20260912-r23";
import { createParticipantReference, publicParticipantReference } from "./participant-reference.js?v=v7-20260912-r23";
import { buildReferralBatch, parseReferralRecipients, safeReferrerLabel } from "./referral.js?v=v7-20260912-r23";
import { EXHIBITION_OPEN_CALL, buildExhibitionApplicationPayload, createDefaultExhibitionApplication, validateExhibitionApplication } from "./exhibition-application.js?v=v7-20260912-r23";
...
const buildStamp = "e5688003cb70-dirty 2026-09-12T12:28:03.826Z";
