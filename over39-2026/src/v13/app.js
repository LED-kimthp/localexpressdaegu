import { localizeQuestion, translate } from "./i18n.js?v=v7-20260913-r34";
import { COORDINATE_SCOPE_LABELS, buildCoordinateSnapshots, deriveCoordinateScope, deriveSContextTags } from "./classification.js?v=v7-20260913-r34";
import { buildConnectionProfile, connectionTopics } from "./connection.js?v=v7-20260913-r34";
import { applicableFixedQuestionIds, buildActiveScreens, fixedQuestionIdsForScreen, flowCounts, hasSubstantiveDChange, hasSubstantiveTransition, needsContinuityQuestion, needsPauseContext, normalizedDScope, resetForRouteChange, sanitizeAnswersForRoute, withdrawAnswer } from "./flow.js?v=v7-20260913-r34";
...
import { normalizeIntegratedRoleRecord, shouldShowP13Text, shouldShowP19Text, translationReuseDecision } from "./integration-r2-helpers.js?v=v7-20260913-r34";
...
import { QUESTION_METADATA } from "./question-map.js?v=v7-20260913-r34";
import { createEnvelope, readOutbox, retryOutbox, sendEnvelope, splitResearchAndContact } from "./storage.js?v=v7-20260913-r34";
import { RESPONSE_DOCUMENT_VERSION, buildResponseDocument, rawParticipantWords, renderResponseDocument } from "./response-document.js?v=v7-20260913-r34";
import { responseDocumentFrame } from "./response-document-i18n.js?v=v7-20260913-r34";
import { compactParticipantContext, contextAwareCopy, dContextHints, hasParticipantContext, participantContextKind, participantContextOptions } from "./participant-context.js?v=v7-20260913-r34";
import { participantActivityScreenCopy, participantContextCopy } from "./participant-context-i18n.js?v=v7-20260913-r34";
import { greetingUiCopy } from "./greetings-ui-i18n.js?v=v7-20260913-r34";
import { rc2UiCopy, rc2UiPhrase } from "./rc2-ui-i18n.js?v=v7-20260913-r34";
import { completionCopy } from "./completion-i18n.js?v=v7-20260913-r34";
import { greetingVisibilityCopy, stage1ConsentCopy, stage1Copy, stage1UiExtraCopy } from "./stage1-i18n.js?v=v7-20260913-r34";
import { greetingFirstCopy } from "./greeting-first-i18n.js?v=v7-20260913-r34";
import { greetingSimplificationCopy } from "./greeting-simplification-i18n.js?v=v7-20260913-r34";
import { task7Copy } from "./task7-i18n.js?v=v7-20260913-r34";
import { createParticipantReference, publicParticipantReference } from "./participant-reference.js?v=v7-20260913-r34";
import { buildReferralBatch, parseReferralRecipients, safeReferrerLabel } from "./referral.js?v=v7-20260913-r34";
import { EXHIBITION_OPEN_CALL, buildExhibitionApplicationPayload, createDefaultExhibitionApplication, validateExhibitionApplication } from "./exhibition-application.js?v=v7-20260913-r34";
...
const buildStamp = "8d8d2636e742-dirty 2026-09-13T05:03:27.844Z";
