...
const contextualCopy = {
  ko: {
    ...
    PROFESSIONAL: { activityHeading: "현재의 활동과 외부와 만나는 방식을 나누어 살펴볼게요.", p14: "현재 가장 중요한 문화예술 활동은 어떤 상태에 가까운가요?", p15: "현재 그 활동이 외부와 만나는 방식은 어떤 상태에 가까운가요?", p12: "그 전후로 달라진 것을 한 가지 들려주세요.", p13: "밖에서는 잘 보이지 않았지만, 그 시기에도 이어지고 있던 것이 있었나요?", p16: "현재의 활동 방식에 영향을 주고 있는 현실은 무엇인가요?", p19: "지금까지 활동을 이어오게 한 기반이나 계기는 무엇이었나요?" },
  },
  en: {
